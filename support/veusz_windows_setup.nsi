...
Section "MainSection" SEC01
  ...
  SetOutPath "$INSTDIR\PyQt6\Qt\translations"
  File "${PYINST_DIR}\PyQt6\Qt\translations\*.qm"
  SetOutPath "$INSTDIR\PyQt6\Qt\plugins\iconengines"
  File "${PYINST_DIR}\PyQt6\Qt\plugins\iconengines\*.dll"
  SetOutPath "$INSTDIR\PyQt6\Qt\plugins\imageformats"
  File "${PYINST_DIR}\PyQt6\Qt\plugins\imageformats\*.dll"
  SetOutPath "$INSTDIR\PyQt6\Qt\plugins\platforms"
  File "${PYINST_DIR}\PyQt6\Qt\plugins\platforms\*.dll"
  SetOutPath "$INSTDIR\PyQt6\Qt\plugins\printsupport"
  File "${PYINST_DIR}\PyQt6\Qt\plugins\printsupport\*.dll"
...
Section Uninstall
  ...
  Delete "$INSTDIR\PyQt6\Qt\plugins\iconengines\*.dll"
  Delete "$INSTDIR\PyQt6\Qt\plugins\imageformats\*.dll"
  Delete "$INSTDIR\PyQt6\Qt\plugins\platforms\*.dll"
  Delete "$INSTDIR\PyQt6\Qt\plugins\printsupport\*.dll"
  Delete "$INSTDIR\PyQt6\Qt\translations\*.qm"
  ...
  RMDir "$INSTDIR\numpy\random"
  RMDir "$INSTDIR\numpy"
  RMDir "$INSTDIR\PyQt6\Qt\plugins\iconengines"
  RMDir "$INSTDIR\PyQt6\Qt\plugins\imageformats"
  RMDir "$INSTDIR\PyQt6\Qt\plugins\platforms"
  RMDir "$INSTDIR\PyQt6\Qt\plugins\printsupport"
  RMDir "$INSTDIR\PyQt6\Qt\plugins"
  RMDir "$INSTDIR\PyQt6\Qt\translations"
  RMDir "$INSTDIR\PyQt6\Qt"
  RMDir "$INSTDIR\PyQt6"
  RMDir "$INSTDIR\ui"
